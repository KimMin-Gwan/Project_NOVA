...
function App() {
  ...
  let jwt =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlc3RVc2VyQG5hdmVyLmNvbSIsImlhdCI6MTcyMzk5NDMzMCwiZXhwIjoxNzIzOTk2MTMwfQ.PWzlMUMKjMrgxc8Yl59-eIQPLP0QasunTnNl487ZWMA";
          ...
          <div className="container">
            ...
            <section className="solo-bias-rank">
              <div className="title-area">
                ...
                <div
                  className={`toggle-container ${isClicked ? "" : "active"}`}
                >
                  <div
                    onClick={() => {
                      handleToggle();
                    ...
                    className={`text ${isClicked ? "" : "active"}`}
                  >
                    내 최애
                  </div>
                  <div
                    ...
                    return (
                      <div className="행성 " key={i}>
                        <button
                          onClick={() => {
                            fetch(
                              url + `show_league?league_name=${[leagues[i]]}`
                            )
                              .then((response) => response.json())
                              .then((data) => {
                          ...
                          className={
                            clickedIndex === i ? "click-now" : "non-click"
                          }
                          click
                        >
                          {leagues[i]}
