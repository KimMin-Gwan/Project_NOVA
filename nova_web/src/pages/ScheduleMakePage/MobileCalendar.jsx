...
const MobileCalender = ({
  ...
  return (
    <div>
      <div className={style["mobile-calendar-component"]}>
        <div className={style["mobile-calendar-component-title"]}>
          <span className={style["bias-select-section-title"]}>날짜 선택</span>
        </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: day == dayState ? "#b9d5ffff" : "transparent",
        border: IsToday? "1px solid #83b5ff" : "none",
        }}
      onClick={()=>trySelectDay(day)}
    >
      <span
      className={style["day-component-title-span"]}
      style={{ fontSize: body ? "18px" : "22px" }}
      >
      {day}
      </span>
      {body && (
