...
export default function LeaguePage() {
    ...
    useEffect(() => {
        ...
        wsRef.current = new WebSocket('wss://nova-platform.kr/league_detail/league_data?league_name=고양이 은하');
        ...
        //     // console.log('split', realData);
        //     // console.log('plelaela', receiveData);
